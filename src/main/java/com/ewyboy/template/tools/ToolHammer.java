...
public class ToolHammer extends Tool3x3 {
    ...
    public ToolHammer(float attackDmg, float attackSpeed, IItemTier tier) {
        super(1, attackDmg, attackSpeed, tier, DIGGABLES, new Properties().addToolType(ToolType.PICKAXE, tier.getLevel()).tab(HammerTime.ITEM_GROUP));
    }
